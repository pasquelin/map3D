...
| `providers.tiles.errorTtlMs` | Duration (ms) during which a failed tile is not requested again. <!-- audit: à vérifier à la fusion (cœur) --> | `30000` |
| `providers.tiles.staleFrames` | Number of frames without use before a tile is deemed stale and evicted. <!-- audit: à vérifier à la fusion (cœur) --> | `120` |
| `providers.tiles.fetch.timeoutMs` | Give up on a request with no response. `0` = no limit. <!-- audit: à vérifier à la fusion (cœur) --> | `10000` |
...
| `providers.buildings.errorTtlMs` | Duration (ms) during which a failed tile is not requested again. <!-- audit: à vérifier à la fusion (cœur) --> | `30000` |
| `providers.buildings.staleFrames` | Number of frames without use before a tile is deemed stale and evicted. <!-- audit: à vérifier à la fusion (cœur) --> | `120` |
...
| `interaction.lockFlashMs` | Duration (ms) of the flash signalling a locked interaction. <!-- audit: à vérifier à la fusion (cœur) --> | `800` |
...
| `performance.shapeGroundSamples` | Number of ground-draping samples per shape. <!-- audit: à vérifier à la fusion (cœur) --> | `16` |
