...
```tsx
import { myOfficialPlugin } from '@pasquelin/map3d-plugin-something'
...
official plugins (`@pasquelin/map3d-plugin-geopf`, `@pasquelin/map3d-plugin-windy`,
`@pasquelin/map3d-plugin-plan-3d` — see § 13).
