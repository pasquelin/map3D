...
| `providers.buildings.maxViewDistance` | Portée maximale (m) de l'emprise servie aux bâtiments ; au-delà, le fond raster reste seul. ⚠️ C'est elle qui rend la couverture **continue** en vue inclinée. Sans borne, l'emprise venait d'une grille de rayons dont ceux qui franchissent l'horizon étaient ignorés : portée en dents de scie entre 2,8 et 36,3 km, deux effondrements brutaux (59°, 74°), et de 8 à 1 058 tuiles demandées à altitude constante. Monter la portée se paie en RAM (pic en n² : 24 tuiles à 6 km, 40 à 8 km). | `6000` |
...
| `providers.buildings.maxRequest` | Budget de tuiles demandées pour une vue. ⚠️ Ce n'est plus qu'un **filet** : c'est `maxViewDistance` qui borne désormais la portée, et le pic mesuré à 6 km est de 24 tuiles. Auparavant, ce budget déclenchait un repli en carré de côté fixe autour du point regardé dès qu'il était dépassé — d'où une bascule brutale d'un régime à l'autre en vue inclinée. Cf. [TILES.md § 5](TILES.md). | `49` |
