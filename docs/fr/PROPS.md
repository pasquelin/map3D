...
Les défauts visuels des props ci-dessous viennent de `theme.relations` (cf. [THEME.md](THEME.md#relations--défauts-des-liens-de-relation)) ; le palier de zoom initial est lu sur la caméra au montage, plus un `14` en dur.
