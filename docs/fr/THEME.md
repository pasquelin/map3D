...
| `globe.buildingHoverColor` | Teinte d'un bâtiment survolé, l'outil de sélection actif. Elle REMPLACE la couleur des sommets de l'emprise — ombrage compris, qui est cuit dedans : c'est ce qui la fait ressortir d'un quartier entier. | `'#F2B441'` |
