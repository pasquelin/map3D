 ...
 * les consommateurs sont des compteurs de diagnostic et le cull de tuiles (`intersectsView`),
 * pour qui un faux positif au bord du ±180° coûte au pire une tuile gardée une frame de trop
 * — là où l'inventaire de la loupe, lui, doit être exact.
 */
